...
-- /developers-login. The username is stored here and mapped to a synthetic
...
COMMENT ON COLUMN public.profiles.username IS
  'Login handle for developer accounts (username sign-in at /developers-login). NULL for everyone else.';

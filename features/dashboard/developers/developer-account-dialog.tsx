 ...
 * server-side; the developer signs in at /developers-login. The company picker is
 ...
 */
export function DeveloperAccountDialog({
  open,
  preset,
  onClose,
  onSaved,
  ...
  const handleSubmit = async () => {
    ...
    if (!/^[a-z0-9._-]{3,32}$/.test(uname)) {
      onError(
        "Username must be 3–32 characters: lowercase letters, numbers, dot, underscore, or hyphen.",
      );
      return;
    }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#6b7280]">
                  Username + password login for a developer partner
                </p>
              </div>
            </div>
            <button
          ...
          <div className="overflow-y-auto flex-1 px-6 py-5 space-y-5">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#9ca3af] mt-1 ml-1">
                The account will be linked to this company.
              </p>
            </div>
            ...
            {developerId && (
              <div className="rounded-2xl border border-[#eef0f2] bg-[#f9fafb] p-4">
                ...
                {accountsLoading ? (
                  ...
                  <p className="text-xs text-[#9ca3af] py-1.5">
                    No accounts yet for this developer.
                  </p>
                ) : (
                  <div className="space-y-1.5 max-h-44 overflow-y-auto">
                    {accounts.map((a) => (
                      <div
                        key={a.id}
                        className="flex items-center gap-2.5 rounded-xl bg-white border border-[#eef0f2] px-3 py-2"
                      >
                        <UserAvatar
            ...
            <div>
              ...
              <p className="text-[11px] text-[#9ca3af] mt-1 ml-1">
                Share these credentials with the developer securely. Resets are
                admin-managed.
              </p>
            </div>

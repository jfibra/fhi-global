...
import {
  ...
  type DeveloperLoginState,
} from "@/app/(public-page)/(auth)/developers-login/actions";
...
/**
 * /developers-login — username + password sign-in for developer partners
        ...
        <div className="w-full max-w-[400px] mx-auto text-center">
          ...
          <div className="flex items-start gap-2.5 rounded-xl bg-[#eaf3fb] border border-[#d3e6f5] px-4 py-3 mb-5 text-left">
            ...
            <p className="text-[13px] text-[#3a5a78] leading-relaxed">
              Developer access — sign in with your username and password.
              Contact your FHI Global admin if you need an account.
            </p>
          </div>
          ...
          <form action={formAction} className="space-y-4">
            ...
            {state.error && (
              <div className="flex items-start gap-2 p-3 rounded-xl bg-rose-50 border border-rose-200">
                <span className="text-rose-400 mt-px text-sm leading-none">
                  ✕
                </span>

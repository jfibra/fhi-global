...
export function ContactDetailClient({ id }: { id: string }) {
  ...
  const handleDelete = async () => {
    ...
    else router.push("/dashboard/admin/contact-inbox")
  }
  ...
  if (error || !submission) {
    return (
      <div className="max-w-2xl mx-auto py-16 text-center space-y-4">
        ...
        <Link href="/dashboard/admin/contact-inbox" className="inline-flex items-center gap-2 text-sm font-semibold text-[#001f3f] hover:underline">
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <Link href="/dashboard/admin/contact-inbox" className="inline-flex items-center gap-2 text-sm font-semibold text-[#374151] hover:text-[#001f3f] transition-colors">
          <ArrowLeft className="w-4 h-4" /> Back to Contact Inbox
        </Link>

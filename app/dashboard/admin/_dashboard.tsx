...
const QUICK_ACTIONS: QuickAction[] = [
  { label: "Add Developer",        desc: "Invite a partner firm",     href: "/dashboard/developers", icon: Users       },
  { label: "Add Project",          desc: "Publish a new launch",      href: "/dashboard/projects",   icon: Building2   },
  { label: "Encode Sale",          desc: "Log a reservation",         href: "/dashboard/sales",      icon: ShoppingCart },
  { label: "Create Support Ticket",desc: "Raise an incident",         href: "/dashboard/support",    icon: LifeBuoy    },

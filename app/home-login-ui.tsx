...
export function HomeLoginUI() {
  ...
  return (
    <section className="bg-[#f4f6f9] py-14 md:py-20">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div className="grid lg:grid-cols-[1fr_440px] xl:grid-cols-[1fr_480px] gap-10 xl:gap-16 items-center">

          {/* ── Left: editorial panel ─────────────────────── */}
          <div className="hidden lg:flex flex-col justify-center relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#001f3f] via-[#002a52] to-[#001428] p-12 xl:p-16 min-h-[600px]">
            {/* Dot grid */}
            <div
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div>
                <h1 className="font-['Space_Grotesk'] text-4xl xl:text-5xl font-bold text-white leading-[1.15] mb-5">
              ...
              <div className="space-y-4">
                {PILLARS.map(({ icon: Icon, label, desc }) => (
                  <div key={label} className="flex items-start gap-4 group">
                    <div className="w-9 h-9 rounded-2xl bg-white/8 border border-white/12 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-[#d6b357]/15 group-hover:border-[#d6b357]/30 transition-all duration-300">
          ...
          {/* ── Right: login card ─────────────────────────── */}
          <div>
            <div className="bg-white rounded-[28px] border border-[#e8eaed] shadow-[0_8px_48px_-8px_rgba(0,31,63,0.10)] p-8 lg:p-10">
              ...
              <div className="mb-8">
                ...
                <h2 className="font-['Space_Grotesk'] text-2xl font-bold text-[#0d1117] mb-1.5">
                  Welcome back
                </h2>
